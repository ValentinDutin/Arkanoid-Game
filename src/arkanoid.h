...
struct ArkanoidSettings
{
    ...
    int bricks_columns_count = 10;
    int bricks_rows_count = 3;
...
public:
    ...
    virtual void update(ImGuiIO& io, ArkanoidDebugData& debug_data, float elapsed, const ArkanoidSettings& settings) = 0;
};
